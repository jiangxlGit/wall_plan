package com.jloved.example.springmvc.servlet;
...
import com.jloved.example.springmvc.context.WebApplicationContext;
import com.jloved.example.springmvc.handler.MyHandler;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //1、加载初始化参数   classpath:spring-mvc.xml
