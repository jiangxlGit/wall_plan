 ...
 */
@Slf4j
@Component(value = "kafkaTestConsumer3")
@ConsumerType(type = "consumerTopicNameTest")
public class KafkaTestConsumer3 extends AbstractKafkaConsumer<String, String> implements IKafkaConsumer<String, String> {
    
    @Override
    public void onMessage(ConsumerRecord<String, String> record) {
        try {
            log.info("------> kafka-3 消费到消息：{}", record.value());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
